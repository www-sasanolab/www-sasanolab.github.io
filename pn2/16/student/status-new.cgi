...
my $sql = "SELECT programs.kai,programs.kihon_hatten,";
$sql .= " programs.bangou,programs.status,programs.studentID from programs";
$sql .= " LEFT OUTER JOIN teishutsuok";
$sql .= " ON programs.kai=teishutsuok.kai";
$sql .= " and programs.kihon_hatten=teishutsuok.kihon_hatten";
$sql .= " and programs.bangou=teishutsuok.bangou";
$sql .= " and programs.studentID = '$studentID';";
...
while (my $ary_ref = $sth->fetchrow_arrayref) {
    my ($kai, $kihon_hatten, $bangou, $status) = @$ary_ref; # @をつけて配列にする
    # $ary_refは配列へのレファレンス
    print "<tr>";
    print "<td>";
    print "第" . $kai . "回";
