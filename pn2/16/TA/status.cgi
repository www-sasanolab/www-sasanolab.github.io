...
require "/home/cs/dbinfo/dbinfo2016.txt";
...
$sql = "SELECT programs.studentID,rishusha.name,kai,kihon_hatten,bangou,status";
...
while (my $ary_ref = $sth->fetchrow_arrayref) {
    my ($studentID, $name, $kai, $kihon_hatten, $bangou, $status) = @$ary_ref; # @をつけて配列にする
    # $ary_refは配列へのレファレンス
    print "<tr>";
