...
require "/home/cs/dbinfo/dbinfo2022.txt";
...
$sql = "SELECT programs.studentID,rishusha.name,kai,kihon_hatten,bangou,status,comment,jikoku";
...
while (my $ary_ref = $sth->fetchrow_arrayref) {
    my ($studentID, $name, $kai, $kihon_hatten, $bangou, $status, $comment, $jikoku) = @$ary_ref; # @をつけて配列にする
    # $ary_refは配列へのレファレンス
    print "<tr>";
    ...
    print "</td>";
    print "<td>"
	. "<form action=\"commentsend.cgi\" method=\"post\">"
