...
How to execute
Invoke SML/NJ (an interpreter of Standard ML) as follows.
% sml a.sml
Then type an expression like "showx c" and "showy c" as follows.
- showx c;
You need to install SML/NJ by yourself.
*)
